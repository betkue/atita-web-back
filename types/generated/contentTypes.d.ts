...
export interface ApiChooseAreaModelChooseAreaModel
  extends Struct.SingleTypeSchema {
  collectionName: 'choose_area_models';
  info: {
    description: '';
    displayName: 'chooseAreaModel';
    pluralName: 'choose-area-models';
    singularName: 'choose-area-model';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::choose-area-model.choose-area-model'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    ...
    title1_ex: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiContactModelContactModel extends Struct.SingleTypeSchema {
  collectionName: 'contact_models';
  info: {
    description: '';
    displayName: 'contactModel';
    pluralName: 'contact-models';
    singularName: 'contact-model';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact-model.contact-model'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDownloadLinkDownloadLink
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    plateformName: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiDownloadSectionDownloadSection
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    downloadLinks: Schema.Attribute.Relation<
      'oneToMany',
      'api::download-link.download-link'
    >;
    imageSrc: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
...
export interface ApiFaqModelFaqModel extends Struct.SingleTypeSchema {
  collectionName: 'faq_models';
  info: {
    description: '';
    displayName: 'faqModel';
    pluralName: 'faq-models';
    singularName: 'faq-model';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiRentModelRentModel extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'rentModel';
    pluralName: 'rent-models';
    singularName: 'rent-model';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultListItem: Schema.Attribute.String & Schema.Attribute.Required;
    listItem1: Schema.Attribute.String & Schema.Attribute.Required;
    listItem2: Schema.Attribute.String & Schema.Attribute.Required;
    listItem3: Schema.Attribute.String & Schema.Attribute.Required;
    listItem4: Schema.Attribute.String & Schema.Attribute.Required;
    listItem5: Schema.Attribute.String & Schema.Attribute.Required;
    listItem6: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::rent-model.rent-model'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    text1: Schema.Attribute.String & Schema.Attribute.Required;
    text2: Schema.Attribute.String & Schema.Attribute.Required;
    textLink: Schema.Attribute.String & Schema.Attribute.Required;
    title1: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiRestaurantModelRestaurantModel
  extends Struct.SingleTypeSchema {
  collectionName: 'restaurant_models';
  info: {
    displayName: 'RestaurantModel';
    pluralName: 'restaurant-models';
    singularName: 'restaurant-model';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::restaurant-model.restaurant-model'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    text1: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiVehicleVehicle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    luggageCapacity: Schema.Attribute.Integer & Schema.Attribute.Required;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    passengers: Schema.Attribute.Integer & Schema.Attribute.Required;
    pricePerDay: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::contact-model.contact-model': ApiContactModelContactModel;
